...
const Footer = () => {
  ...
  return (
    <>
      ...
      />
      <footer
        className="fixed bottom-0 left-0 right-0 bg-[var(--background)] text-gray-200 z-50 border-t border-black
          h-auto min-h-[60px] py-4 px-4
          md:h-14 md:py-0
      ...
      >
        ...
        <div className="flex items-center space-x-4">
          <Image
            ...
            height={12}
            priority
            className="w-6 h-3 md:w-6 md:h-3"
          />
          <p className="text-[10px] md:text-xs" itemScope itemType="https://schema.org/Organization">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6 md:w-5 md:h-5 fill-[#C6E1E7]">
        ...
        {/* Navigation Links */}
        <nav aria-label="Footer navigation" className="flex flex-wrap justify-center items-center gap-2 md:gap-4">
          <Link
            href="/about"
            className="relative text-[10px] md:text-xs text-[#C6E1E7] hover:text-white transition-all duration-300 group px-2 py-1 md:px-3 md:py-2 active:scale-95"
          >
            About Us
