...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer
       className="fixed bottom-0 left-0 border-top right-0 text-gray-200 z-50"
        role="contentinfo"
        aria-label="Main footer"
      >
        {/* Company Info */}
        <div className='flex items-center'>
          <div className="flex-1 h-12 px-5 bg-gray-700">
            <Image
          ...
          <div className="flex-1 bg-gray-800">
            <div className="flex justify-center gap-8">
              ...
              <Link
                ...
                target="_blank"
                className={styles.navItem}>
                <svg viewBox="6 0 20 20" aria-hidden="true" className="size-7 fill-gray-400"><g strokeWidth="0"></g><g strokeLinecap="round" strokeLinejoin="round"></g><g><path d="M21.95 5.005l-3.306-.004c-3.206 0-5.277 2.124-5.277 5.415v2.495H10.05v4.515h3.317l-.004 9.575h4.641l.004-9.575h3.806l-.003-4.514h-3.803v-2.117c0-1.018.241-1.533 1.566-1.533l2.366-.001.01-4.256z"></path></g></svg>
              </Link>
            </div>
          </div>

          {/* Navigation Links */}
          <nav aria-label="Footer navigation" className="flex-1 bg-gray-900">
            <Link
              href="/privacy"
