...
const Footer = () => {
  ...
  return (
    <>
      ...
      />
      <footer
        className="fixed bottom-0 left-0 right-0 bg-[var(--background)] text-gray-200 z-50 shadow-[0_-8px_32px_rgba(0,0,0,0.2)] flex flex-col md:flex-row items-center px-4 py-3 md:py-0"
        role="contentinfo"
      ...
      >
        ...
        <div className="flex items-center justify-center space-x-4 mb-3 md:mb-0 md:flex-1">
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 fill-[#C6E1E7] hover:fill-white">
