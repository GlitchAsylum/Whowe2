    ...
    <div className="flex justify-center items-center min-h]">
      <main className="flex flex-col w-90 gap-4 items-center text-center">
        <Image
          ...
          priority
        />
        <h1 className="text-5xl font-bold leading-tight tracking-[.05em]">Whowe</h1>
        <h3 className="text-2xl font-bold leading-tight tracking-[.05em]">Everyone has a story.</h3>
        ...
        <Button onClick={handleClick} variant="glass" size="large" >I HAVE A STORY TO TELL</Button>
      </main>
    </div>
  );
}
